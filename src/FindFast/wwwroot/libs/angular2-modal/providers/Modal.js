System.register(['angular2/core', '../models/ModalConfig', '../models/ModalDialogInstance', '../components/modalBackdrop', '../components/bootstrapModalContainer'], function(exports_1) {
    ...
    var core_1, ModalConfig_1, ModalDialogInstance_1, modalBackdrop_1, bootstrapModalContainer_1;
    var _config, Modal;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (modalBackdrop_1_1) {
                modalBackdrop_1 = modalBackdrop_1_1;
            },
            function (bootstrapModalContainer_1_1) {
                bootstrapModalContainer_1 = bootstrapModalContainer_1_1;
            }],
        execute: function() {
            Modal = (function () {
