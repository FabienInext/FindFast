System.register(['./models/ICustomModal', './models/ModalConfig', './models/ModalDialogInstance', './components/modalBackdrop', './components/bootstrapModalContainer', './providers/Modal', './commonModals/yesNoModal', './commonModals/okOnlyModal'], function(exports_1) {
